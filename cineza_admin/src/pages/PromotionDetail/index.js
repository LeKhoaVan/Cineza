...
const PromotionDetail = ({ codePromotion, onClickHandleClose, addBtn }) => {
    ...
    useEffect(() => {
        const getAllPromotionHeader = async () => {
            try {
                const allPromotionHeader = await axios.get("http://localhost:9000/cineza/api/v1/promotion-header/get-all");
            ...
            <div className="promotion-detail-container">
                <div className="promotion-detail-header">
                    ...
                    <div className="promotion-detail-header-name">
                        <p>{code}: Từ ngày {formatDateHandle(startDay)} Đến ngày {formatDateHandle(endDay)} </p>
                    </div>
                </div>
                        ...
                        <div className="promotion-detail-input">
                            ...
                            <div className="input-promotion-container">
                                <FormControl
                                    ...
                                    size="small"
                                >
                                    <InputLabel id="demo-select-small-label">Thuộc chương trình</InputLabel>
                                    <Select
                        ...
                        <div className="promotion-detail-input">
                            ...
                            <div className="input-promotion-container">
                                <FormControl
                                    ...
                                    size="small"
                                >
                                    <InputLabel id="demo-select-small-label">Loại hình khuyến mãi</InputLabel>
                                    <Select
                                        labelId="demo-select-small-label"
                                        id="demo-select-small"
                                        value={typePromotion}
