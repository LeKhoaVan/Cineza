...
import { formatDateHandle, formatFromObjectToDate } from "../../components/util/index";
            ...
            <div className="promotion-detail-container">
                <div className="promotion-detail-header">
                    ...
                    <div className="promotion-detail-header-name">
                        <p>{code}: Từ ngày {formatDateHandle(startDayShow)}  Đến ngày {formatDateHandle(endDayShow)} </p>
                    </div>
                </div>
                        ...
                        <div className="promotion-detail-input">
                            ...
                            <div className="input-promotion-container">
                                <textarea
                                    ...
                                    value={description}
                                    readOnly={!edit}
                                    style={edit ? { height: "70px" } : { height: "70px", background: "rgb(196, 196, 196)" }}
