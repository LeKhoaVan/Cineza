...
const getRapByCodeService = async (code) => {
    const query = `select r.code, r.name, r.openTime, r.closeTime, r.status, px.fullName as nameWard, qh.fullName as nameDistrict, ttp.fullName as nameCity, qg.fullName as nameCountry from rap as r
